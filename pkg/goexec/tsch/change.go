...
import (
	...
	"github.com/atoz-project/go-exec/pkg/goexec/tsch/task"
...
func (m *TschChange) Clean(ctx context.Context) error {
	// Clean method-level resources first, then base TSCH connection resources.
	return errors.Join(m.Cleaner.Clean(ctx), m.Tsch.Clean(ctx))
}
